...
<div class="preview-wrapper">
    ...
    <div class="action-bar">
        <button type="button" class="btn btn-print" data-aksi="cetak">Cetak Invoice</button>
        <button type="button" class="btn btn-close" data-aksi="tutup">Tutup</button>
    </div>
    ...
    <div class="page">
        ...
        {{-- Footer --}}
        {{-- Teks footer disiapkan InvoiceController. Template tidak lagi
             menembak database sendiri. --}}
...
<script>
// Tombol cetak dan tutup dipasang lewat addEventListener, bukan atribut
// onclick, agar halaman ini tetap berjalan di bawah Content Security Policy.
document.querySelectorAll("[data-aksi]").forEach(function (el) {
    el.addEventListener("click", function () {
        if (el.dataset.aksi === "cetak") { window.print(); }
        if (el.dataset.aksi === "tutup") { window.close(); }
    });
});
</script>
</body>
