            ...
            <form method="POST" action="{{ route('servis.store') }}" class="space-y-6" id="formServis">
                ...
                <div class="flex flex-col items-center gap-4">
                    ...
                    {{-- Sebelumnya pola yang lebih pendek dari 4 titik dibuang
                         diam-diam — dotCount dan patternDisplay tetap
                         menunjukkan angka seolah tersimpan, padahal field
                         tersembunyinya dikosongkan lagi tanpa peringatan
                         apa pun. Admin baru sadar saat data hilang. --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="status" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            {{-- Pilihan status berasal dari konstanta model,
                                 sumber yang sama dengan aturan validasi. --}}
...
function updateUI() {
    ...
    // Beri tahu secara terang-terangan bila pola yang barusan digambar
    // terlalu pendek untuk disimpan, alih-alih membuangnya diam-diam.
