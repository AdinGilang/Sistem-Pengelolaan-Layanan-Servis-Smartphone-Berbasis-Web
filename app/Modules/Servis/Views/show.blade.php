<x-app-layout>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4 text-sm text-gray-500 flex-wrap">
                        ...
                        @if($servis->tanggal)
                            <span>Masuk: {{ $servis->tanggal->translatedFormat('d F Y') }}</span>
                        @endif
                        @if($servis->teknisi)
                            <span>Teknisi: {{ $servis->teknisi }}</span>
                        @endif
                    </div>
                </div>
                        ...
                        <div style="border-radius:10px;padding:12px 14px;
                            ...
                            @elseif($estTgl->lt($today))
                                <div class="font-semibold text-sm" style="color:#9a3412;">
                                    Terlambat {{ $today->diffInDays($estTgl) }} hari
                                </div>
                            @elseif($estTgl->isToday())
                                <div class="font-semibold text-sm" style="color:#92400e;">Jatuh tempo hari ini</div>
                            @else
                ...
                @if($servis->hasPin())
                    <div>
                        ...
                        <div style="display:flex;align-items:center;gap:12px;">
                            ...
                            <button type="button" id="pin_toggle_trigger"
                                    id="pin_toggle_btn"
                            ...
                            <div style="background:#f8f9ff;border:1px solid #e0e4ff;border-radius:10px;padding:14px;">
                                ...
                                <div class="flex items-center gap-2">
                                    <input type="password" id="pin_verify_input"
                                           ...
                                           autocomplete="off">
                                    <button type="button" id="pin_verify_submit"
                                            class="px-4 py-1.5 bg-blue-600 text-white rounded-lg text-sm hover:bg-blue-700">
                                        Verifikasi
                                    </button>
                                    <button type="button" id="pin_verify_cancel"
    ...
    @can("viewCredentials", $servis)
        @include("servis::partials.kredensial")
    @endcan
</x-app-layout>
